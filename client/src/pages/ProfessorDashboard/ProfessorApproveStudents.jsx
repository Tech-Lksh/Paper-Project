...
import axiosInstance from "../../api/axios";  // ← axiosInstance use kar rahe
...
const ProfessorApproveStudent = () => {
  ...
  const fetchStudents = async () => {
    try {
      const res = await axiosInstance.get("/users/department-students", {
  ...
  const grantStudent = async (id) => {
    await axiosInstance.put(`/users/grant-student/${id}`, {}, {
      headers: { Authorization: `Bearer ${token}` }
    });
    fetchStudents();
  };
  ...
  const rejectStudent = async (id) => {
    await axiosInstance.put(`/users/reject-student/${id}`, {}, {
      headers: { Authorization: `Bearer ${token}` }
    });
    fetchStudents();
  };
  ...
  const ungrantStudent = async (id) => {
    await axiosInstance.put(`/users/ungrant-student/${id}`, {}, {
      headers: { Authorization: `Bearer ${token}` }
    });
    fetchStudents();
  };
