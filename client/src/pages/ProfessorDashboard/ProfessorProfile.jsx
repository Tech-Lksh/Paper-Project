...
const Profile = () => {
  ...
  return (
    <div className="flex justify-center mt-1">
      <div className="w-full max-w-5xl   rounded-3xl p-2">
        <div className="flex flex-col md:flex-row gap-8 items-center">
          ...
          <div className="flex flex-col items-center">
            <img
              ...
              alt="profile"
              className="w-40 h-40 md:w-48 md:h-48 rounded-full object-cover border"
            />
        ...
        <div className="mt-5 flex flex-col md:flex-row items-center gap-3 w-full">
          ...
          <Link
            to="/professor-dashboard/upload-paper"
          ...
          <Link
            to="/professor-dashboard/student-approve"
            className="w-full max-w-xl bg-gradient-to-r from-gray-500 to-gray-700 text-white py-4 rounded-2xl text-lg font-semibold shadow-md hover:opacity-90 transition text-center block"
          >
            Student Approve
          </Link>
