...
const StudentGetPaper = () => {
  ...
  const fetchPapers = async () => {
    try {
      ...
      const res = await axiosInstance.get("/papers/search", { params });  // ← axiosInstance use
        ...
        {papers.map((paper) => (
          <div key={paper._id} className="bg-white p-4 rounded-xl shadow hover:shadow-lg transition">
            ...
            <div className="mt-4 flex justify-between">
              <a
                href={`${axiosInstance.defaults.baseURL}/papers/download/${paper.paperFile}`}  // ← axiosInstance baseURL use
...
export default StudentGetPaper;